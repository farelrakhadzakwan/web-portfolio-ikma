...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden py-6 md:py-12 px-2 sm:px-6 md:px-12 flex justify-center bg-[#FFF8FB]">
      ...
      <div className="relative w-full max-w-5xl z-10 flex flex-col md:flex-row shadow-2xl rounded-r-2xl rounded-l-md bg-[#DFD3D8] border border-[#C5B4BA]">
